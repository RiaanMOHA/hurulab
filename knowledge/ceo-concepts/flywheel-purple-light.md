...
Source: CEO concept, claude.ai artifact `b9ac5ffd-115d-4bb0-b892-fd1b84a1d8d4`, recovered
4 September 2026. Subtitle: "Kumamoto ⇄ Tokyo".

**This is proposal A, "Purple Light · vivid twilight".** It is one of two competing design
systems the CEO built to be judged against each other. Its sibling, `flywheel-harmattan.md`,
carries word-for-word identical content in the other system: the argument is held constant so
that only the design is being tested.

The page's own source code was not recoverable, so what follows is its text and structure. The
palette, layout and motion of Purple Light are unseen and would have to be established before it
can be rebuilt.
...
Footer: Hurulab · proposal A "Purple Light" · vivid twilight · Kumamoto ⇄ Tokyo

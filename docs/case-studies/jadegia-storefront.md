...
- Two fully tokenised color systems, 20 tokens each, with programmatic WCAG contrast audits, 34 and 42 pairs tested, and one gray banned for text use (color system pdfs, past sessions).
- Photography direction, including a store visit, background color guidance and image specs (kickoff notes 2026-05-28, meeting notes 2026-06-17).
...
- Forensic beat-driven layout specs for the art collection and product museum templates, layout only, no color, no font, no copy (handoff 2026-06-22).
...
2. Build a behavioral base from Apple's HIG, iOS, iPadOS and macOS documentation via Claude browser prompts, packaged as four base files that survive any brand override (handoff 2026-05-26).
...
5. The client chooses. Here they chose a hybrid: flagship store branding and colors with luxury brand layout and navigation (interview, confirmed by session 2026-06-10).
...
A typical agency would have brought a bigger team and months of static mockups, slower and pricier. A template shop would have skinned a generic Shopify theme (interview). Here, one designer directing AI did the work of a research team, a design team, a copy and translation desk and a QA function, and the client evaluated real software, not pictures of software. The discipline that makes it work is on record: layout specs that carry no color, font or copy so nothing is invented (handoff 2026-06-22); audits that return numbered verdicts naming failures (project working rules); a behavioral accessibility base that no brand decision may override (handoff 2026-05-26); and a hard rule that nothing is added beyond what the spec or the client asked for (handoff 2026-05-26, correction record).
